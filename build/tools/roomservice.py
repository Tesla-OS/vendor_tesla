...
DEBUG = False
default_manifest = ".repo/manifests/tesla_default.xml"
...
org_manifest = "TESLA-Devices"  # leave empty if org is provided in manifest
org_display = "TESLA-Devices"  # needed for displaying
